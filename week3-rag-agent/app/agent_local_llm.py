...
RULES (strict):
- Use Session facts and Retrieved context if relevant.
- If Retrieved context is "(none)" or does not contain the answer, say: "Bilmiyorum." (one sentence).
- When you use information from Retrieved context, you MUST cite it with [1], [2], [3] matching the context items.
- Do not invent sources. Do not cite if you didn't use the context.
...
def run_agent_local(
    question: str, history: list[dict], facts_text: str, context_text: str
) -> AgentResult:
    history_text = (
